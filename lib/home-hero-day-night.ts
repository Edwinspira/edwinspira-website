...
/** Cache-bust when hero loop MP4s change. */
export const HERO_DAY_VIDEO_SRC = "/images/videos/Dia.mp4?v=matched6";
export const HERO_NIGHT_VIDEO_SRC = "/images/videos/Noche.mp4?v=matched6";
