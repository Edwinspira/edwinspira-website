...
export function HomeCyberFrame({ children }: { children: ReactNode }) {
  return (
    <div className="home-cyber-frame pointer-events-none absolute top-0 bottom-[2.5vh] left-[var(--home-pad)] z-[25] flex items-end gap-2 pb-3 pl-3 sm:bottom-[12vh] sm:gap-5 sm:pb-7 sm:pl-6">
      ...
      <div className="home-cyber-frame__cluster pointer-events-auto flex items-end gap-2 sm:gap-5">
        {children}
      </div>
    </div>
  );
