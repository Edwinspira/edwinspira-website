...
export function HomeCyberFrame({ children }: { children: ReactNode }) {
  return (
    <div className="home-cyber-frame pointer-events-none absolute top-0 bottom-[10vh] left-[var(--home-pad)] z-[25] flex items-end gap-4 pb-6 pl-5 sm:bottom-[12vh] sm:gap-5 sm:pb-7 sm:pl-6">
      ...
      <div className="pointer-events-auto flex items-end gap-4 sm:gap-5">{children}</div>
    </div>
  );
}
